...
# Root directory for raw and processed Hi-C data (HiCARN-style layout).
# Override with HICP2GAN_DATA_ROOT or HICARN_DATA_ROOT.
root_dir = os.environ.get("HICP2GAN_DATA_ROOT", os.environ.get("HICARN_DATA_ROOT", "Data/R16_down"))
...
def data_divider_parser():
    ...
    req_args.add_argument('-s', dest='dataset', help='REQUIRED: Dataset for train/valid/predict(all)',
                          default='train', choices=['K562_test', 'mESC_test', 'train', 'valid', 'GM12878_test', 'NHEK_test', 'HMEC_test'], )
