...
import timm
# Version check - originally required 0.3.2, but allowing 0.6.13 for compatibility
timm_version = timm.__version__
if timm_version not in ["0.3.2", "0.6.13"]:
    print(f"Warning: timm version {timm_version} detected. Code was tested with 0.3.2 and 0.6.13.")
def main(args):
    import socket
